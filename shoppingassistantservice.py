...
def create_app():
    ...
    def talkToOpenAI():
        ...
        design_prompt = (
            f" You are an interior designer that works for CubeMart. You are tasked with providing recommendations to a customer on what they should add to a given room from our catalog. This is the description of the room: \n"
